...
- `main` 代码提交 `d93a8ca` 的[完整成品 CI](https://github.com/WSL043/DSH-Portable/actions/runs/36067981068) 首轮 Windows 2025 移动后冷启动为 13.398 秒，超过原有 12 秒门槛；同轮 Windows 2022 为 8.997 秒。仅复跑失败作业一次，不改代码或门槛，Windows 2025 为 9.608 秒，最终 39/39 通过。保留首轮超限作为慢样本，不据一次复跑宣称长期性能保证。
