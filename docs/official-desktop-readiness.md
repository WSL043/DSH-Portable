...
当前完整设计以 [2026-09-26 长期架构](portable-long-term-architecture.md)为准：官方 Desktop 负责通用桌面能力，Portable 收敛到环境交付、搬迁、更新恢复与空间生命周期；下列早期决定按日期保留，不作为并列的当前指令。
