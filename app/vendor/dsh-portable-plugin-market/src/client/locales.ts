...
export const zh = {
  ...
  confirmInstall: '确认安装',
  installStable: '安装正式版',
  installStableVersion: '安装正式版 {0}',
  installStableBlocked: '正式版暂不兼容',
  installStableHostMismatch: '正式版 {0} 与当前 DSH 不兼容，请选择兼容版本。',
  installPreview: '安装 Beta {0}',
  updatePreview: '更新至 Beta {0}',
  returnStable: '切回正式版 {0}',
  cmdDetails: '安装命令',
  catsMore: '更多分类',
  catsLess: '收起',
  filter: '筛选',
...
export const en: Record<MarketKey, string> = {
  ...
  installStableVersion: 'Install stable {0}',
  installStableBlocked: 'Stable version unavailable',
  installStableHostMismatch: 'Stable version {0} is incompatible with this DSH. Choose a compatible version.',
  installPreview: 'Install Beta {0}',
  updatePreview: 'Update to Beta {0}',
  returnStable: 'Return to stable {0}',
  ...
  statePendingDisable: 'Disable pending restart',
