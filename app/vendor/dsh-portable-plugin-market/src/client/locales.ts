...
export const zh = {
  ...
  catalogRefreshing: '正在更新插件目录…',
  catalogStale: '目录更新失败，当前显示上次同步的内容。',
  loadRetry: '重试',
  installFail: '安装失败',
  openProject: '打开项目主页',
  ...
  upToDate: '已是最新',
  linkedDev: '本地开发链接',
  externalUpdate: '按原来源手动更新',
  externalUpdateHelp: '市场尚不支持此来源的精确更新与回滚，请按原来源的说明更新。',
  readme: '使用说明',
  ...
  opDone: '已完成',
  opDoneLive: '已完成并生效',
  opDoneRefresh: '已完成 · 刷新页面后显示',
  opDoneRestart: '已完成 · 重启 DeepSeek Harness 后生效',
  opNeedsApply: '项待生效',
  ...
  lightboxPrev: '上一张',
  lightboxNext: '下一张',
  envMissing: '内置插件工具不可用。可重新检查；仍失败时请到「设置 → Portable → 检查与修复」处理，无需安装全局 pnpm。',
  envFix: '重新检查',
  envFixing: '正在检查…',
  envFixFail: '内置插件工具检查未通过，请到「设置 → Portable」检查与修复，或导出支持报告。',
  loading: '正在加载插件目录…',
  backTop: '回到顶部',
  confirm: '确认',
  confirmInstall: '确认安装',
...
export const en: Record<MarketKey, string> = {
  ...
  updatesAvailable: '{0} update(s) available',
  backInstalled: 'Back to Installed',
  all: 'All',
  install: 'Install',
  ...
  catalogRefreshing: 'Updating the plugin catalog…',
  catalogStale: 'The catalog could not be updated. Showing the last synced copy.',
  loadRetry: 'Retry',
  ...
  externalUpdate: 'Update from original source',
  externalUpdateHelp: 'Source-exact update and rollback are not supported here. Follow the original source instructions.',
  readme: 'README',
  ...
  opDone: 'Done',
  opDoneLive: 'Complete and active',
  opDoneRefresh: 'Complete · refresh to show changes',
  opDoneRestart: 'Complete · restart DeepSeek Harness to apply',
  opNeedsApply: 'change(s) to apply',
  ...
  lightboxNext: 'Next',
  envMissing: 'The bundled plugin tool is unavailable. Recheck, or open Settings → Portable → Check and repair. No global pnpm installation is needed.',
  envFix: 'Recheck',
  envFixing: 'Checking…',
  envFixFail: 'The bundled tool check failed. Open Settings → Portable to check and repair, or export a support report.',
