...
export const zh = {
  ...
  lightboxPrev: '上一张',
  lightboxNext: '下一张',
  envMissing: '内置插件工具不可用。可重新检查；仍失败时请到「设置 → 桌面与数据 → 维护」处理，无需安装全局 pnpm。',
  envFix: '重新检查',
  envFixing: '正在检查…',
  envFixFail: '内置插件工具检查未通过，请到「设置 → 桌面与数据」检查与修复，或导出支持报告。',
  loading: '正在加载插件目录…',
  backTop: '回到顶部',
  confirm: '确认',
  confirmInstall: '确认安装',
...
export const en: Record<MarketKey, string> = {
  ...
  lightboxNext: 'Next',
  envMissing: 'The bundled plugin tool is unavailable. Recheck, or open Settings → Desktop & data → Maintenance. No global pnpm installation is needed.',
  envFix: 'Recheck',
  envFixing: 'Checking…',
  envFixFail: 'The bundled tool check failed. Open Settings → Desktop & data to check and repair, or export a support report.',
