...
test('CI release gate verifies native desktop ownership, lifecycle, and application identity', async () => {
  ...
  assert.match(dataExportSmoke, /isSeeded: false/)
  ...
  assert.match(dataExportSmoke, /session_projcache\.json/)
  assert.match(dataExportSmoke, /unit: \{ name: 'session_projcache', version: 3 \}/)
  assert.match(dataExportSmoke, /sessionListMetadata:/)
