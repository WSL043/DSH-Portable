...
test('prerelease notes name the actual maturity stage and all prereleases use the preview lock', () => {
  ...
  const alphaUpgrade = renderReleaseNotes('{{CHANNEL_UPGRADE_NOTICE_ZH}}\n{{CHANNEL_UPGRADE_NOTICE_EN}}', 'v0.6.0-alpha.1', '0.1.2-alpha.5')
  assert.match(alphaUpgrade, /历史 RC/)
  assert.match(alphaUpgrade, /historical RC/i)
