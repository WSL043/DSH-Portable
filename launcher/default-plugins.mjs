...
export const PREVIEW_DEFAULT_PLUGINS = Object.freeze([
  ...
  },
  {
    ...
    spec: '1.5.2-beta.1',
    url: 'https://registry.npmjs.org/dsh-chat-manager/-/dsh-chat-manager-1.5.2-beta.1.tgz',
    sha256: 'b32d06e7724a97241659434762d1c173667233217c8f9742e2720d5673f82554',
    integrity: 'sha512-MbP/KOJP9AEfe6tH6CCY+EuGbMfJy9fldx2pP4nQvN1jybIVBR8elHVrlUJmAmtQplxP4naUCAwrIu0R1yJkQA==',
    license: 'MIT',
    reviewedCommit: '576cc45b66100389f4fc8cd012e766e8081f7e23',
    filename: 'dsh-chat-manager.tgz',
  },
].map(Object.freeze))
