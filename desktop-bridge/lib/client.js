  ...
  factory: function (require) {
    ...
    function PortableSettings(ctx, primitives) {
      ...
      const styles = {
        ...
        section: { borderTop: '1px solid var(--dsw-alias-border-l2)', display: 'flex', flexDirection: 'column', marginTop: 16, paddingTop: 10 },
        sectionHeading: { color: 'var(--dsw-alias-label-secondary)', fontSize: 12, fontWeight: 500, lineHeight: '18px', padding: '0 0 2px' },
        item: { display: 'flex', gap: 16, alignItems: 'center', padding: '12px 0', flexWrap: 'wrap' },
      ...
      return h('div', { style: styles.group },
        ...
        h('section', { style: styles.section, 'aria-label': t('maintenance') },
          h('div', { style: styles.sectionHeading }, t('maintenance')),
