  ...
  factory: function (require) {
    ...
    const copy = {
      zh: {
        ...
        engineUnavailableCoreIncompatible: '版本 {0}：此更新包为 Portable {1} 构建，尚未适配当前版本。',
        ...
        community: '帮助与反馈', repository: '项目仓库', reportProblem: '反馈问题', suggestIdea: '提出建议', starProject: '喜欢的话，点个 Star', communityHint: '在 GitHub 打开，由你确认提交；不会自动上传日志或会话。',
      ...
      en: {
        ...
        engineUnavailableCoreIncompatible: 'Version {0}: This update package was built for Portable {1} and is not qualified for the current version.',
        ...
        community: 'Help and feedback', repository: 'Project repository', reportProblem: 'Report a problem', suggestIdea: 'Suggest an idea', starProject: 'Leave a Star', communityHint: 'Opens GitHub for you to review and submit. Logs and sessions are not uploaded automatically.',
